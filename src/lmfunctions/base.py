...
from lmfunctions.lmhub import Hub
...
class Base(BaseModel):
    ...
    def push(self, path: str, objectstore=hub, **kwargs) -> None:
        """
    ...
    def pull(self, path: str, objectstore=hub, **kwargs) -> None:
        """
    ...
    @classmethod
    def from_store(cls, path: str, objectstore=hub, **kwargs):
        """
